...
public class MainActivity extends Activity {
	...
	private static final Map<Integer, Class> pageMap = new HashMap();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pageMap.put(0,FilechooserActivity.class);
		pageMap.put(1,FullScreenActivity.class);
		pageMap.put(2,BrowserActivity.class);
	}
		...
		if (null != this.gridView) {
			...
			this.gridView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> gridView, View view,
					...
					Intent intent = new Intent(MainActivity.this,pageMap.get(position));
